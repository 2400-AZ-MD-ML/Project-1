...
public interface BagInterface<T>
{
   ...
   public boolean remove(T anEntry);
	...
	public T[] toArray();
	/** Looks at all entries in 2 bags, adds all entries into a new bag.
	  @param bag2 the second bag being combined with the original bag.
		@return A newly allocated bag with all entries of both bags.
				Note: if either are null, throws an exception.
	*/
	public BagInterface<T> union(BagInterface<T> bag2);
		/** Looks at all entries in 2 bags, compares them and adds elements into a new bag if they exclusively in the first bag or the number of times greater in the first bag than the second bag.
	...
	*/
	public BagInterface<T> intersect(BagInterface<T> bag2);
		/** Looks at all entries in 2 bags, compares them, adds the elements that are in both bags with similar occurances.
